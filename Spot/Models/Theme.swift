...
class Theme {
    ...
    let markerColours: [Color] = [
        ...
        Color(hue: 0.98, saturation: 0.62, brightness: 0.70, opacity: 1.00), // Red
        ...
        Color(hue: 0.92, saturation: 0.49, brightness: 0.93, opacity: 1.00), // Pink
        Color(hue: 0.975, saturation: 0.49, brightness: 0.93, opacity: 1.00)  // Pink // Chnage
    ]
